...
void setup_scr_blueCounter(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->blueCounter, 480, 800);
    ...
    lv_obj_set_pos(ui->blueCounter_cont_1, 93, 150);
    lv_obj_set_size(ui->blueCounter_cont_1, 294, 500);
    ...
    lv_obj_set_style_radius(ui->blueCounter_cont_1, 35, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->blueCounter_plus, 187, 63);
    ...
    lv_obj_set_pos(ui->blueCounter_minus, 193, 250);
    ...
    lv_obj_set_pos(ui->blueCounter_counter, 58, 185);
    lv_obj_set_size(ui->blueCounter_counter, 114, 126);
    ...
    lv_obj_set_style_radius(ui->blueCounter_counter, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->blueCounter_logo, 11, 26);
    lv_obj_set_size(ui->blueCounter_logo, 60, 85);
    lv_obj_add_flag(ui->blueCounter_logo, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->blueCounter_logo, &_NXP_Logo_RGB565A8_60x85);
